...
download_github_repo() {
    ...
    case "$ARCH" in
        x86_64)
            FILE_URL="https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/cfnat-linux-amd64"
            ;;
        i386)
            FILE_URL="https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/cfnat-linux-386"
            ;;
        aarch64)
            FILE_URL="https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/cfnat-linux-arm64"
            ;;
        arm*)
            FILE_URL="https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/cfnat-linux-arm"
            ;;
        *)
...
download_necessary_files() {
    download_file "https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/ips-v4.txt" "$INSTALL_DIR/ips-v4.txt"
    download_file "https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/ips-v6.txt" "$INSTALL_DIR/ips-v6.txt"
    download_file "https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/locations.json" "$INSTALL_DIR/locations.json"
    download_file "https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/version.txt" "$INSTALL_DIR/version.txt"
...
main_menu() {
    ...
    case $choice in
        ...
        5)
             ...
             if ! curl -fsSLk https://raw.githubusercontent.com/xiaomaye/cfnat-openwrt/refs/heads/main/cfnat.sh -o cfnat.sh; then
             echo -e "${RED}主地址下载失败，正在尝试镜像地址...${NC}"
             if ! curl -fsSLk https://ghproxy.link/https/raw.githubusercontent.com/PoemMistyMoon/cfnat-openwrt/main/cfnat.sh -o cfnat.sh; then
